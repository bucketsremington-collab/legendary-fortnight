...
export default function Landing() {
  const playerCount = mockUsers.filter(u => u.role === 'player').length;
        ...
        <div className="max-w-4xl mx-auto px-4 py-16 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button
              ...
              className="flex items-center gap-2 px-6 py-3 bg-[#5865F2] text-white hover:bg-[#4752C4] transition-colors rounded text-lg"
            >
      ...
      <div className="bg-mc-surface border-b border-mc-border">
        <div className="max-w-4xl mx-auto px-4 py-6">
          <div className="grid grid-cols-3 gap-4 text-center">
            ...
            <div>
              <div className="text-3xl font-bold text-mc-accent">S1</div>
